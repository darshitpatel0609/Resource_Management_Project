		...
		<div class="inner-warpper text-center">
			...
			<form action="HrAuthenticationController" method="post"
				...
				<div class="input-group">
					<label class="palceholder" for="hremail">Email</label> <input
						class="form-control" name="hremail" type="email" placeholder="" />
					<span class="lighting"></span>
				</div>
				<div class="input-group">
					<label class="palceholder" for="hrpassword">Password</label> <input
						class="form-control" name="hrpassword" type="password"
