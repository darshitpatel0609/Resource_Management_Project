		...
		<div class="inner-warpper text-center">
			...
			<form action="AdminAuthenticationController" method="post"
				...
				<div class="input-group">
					<label class="palceholder" for="userName">Email</label> <input
						class="form-control" name="email" value="${emailvalue}"
						type="text" placeholder="" /> <span class="color"><%=email == null ? "" : email%></span><br>
					<br> <span class="lighting"></span>
				</div>
				<div class="input-group">
					<label class="palceholder" for="password">Password</label> <input
						class="form-control" name="password" value="${passwordvalue}"
						type="password" placeholder="" /> <span class="color"><%=password == null ? "" : password%></span><br>
					<br> <span class="lighting"></span>
				</div>
